...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации = МодулиБСП.ДополнительныеОтчетыИОбработки.СведенияОВнешнейОбработке(СтандартныеПодсистемыСервер.ВерсияБиблиотеки());
	...
	ПараметрыРегистрации.Информация = "Обработка позволяет выгрузить встроенные в платформу инструменты как внешние обработки";
...
// * СтандартныеПодсистемыСервер - CommonModule.СтандартныеПодсистемыСервер
Функция МодулиБСП()
	
	ИменаМодулей = "ДополнительныеОтчетыИОбработки,ДополнительныеОтчетыИОбработкиКлиентСервер,СтандартныеПодсистемыСервер";
