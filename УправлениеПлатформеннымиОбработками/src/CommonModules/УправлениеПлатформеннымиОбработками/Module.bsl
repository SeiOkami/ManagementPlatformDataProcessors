...
Процедура УдалитьВсеДанныеПодсистемы() Экспорт
	...
	УдалитьДанныеОбъектаМетаданных(Метаданные.Справочники.ПлатформенныеОбработки);
	УдалитьДанныеОбъектаМетаданных(Метаданные.Справочники.ВерсииПлатформенныхОбработок);
	УдалитьДанныеОбъектаМетаданных(Метаданные.РегистрыСведений.ПодменаПлатформенныхОбработок);
	УдалитьДанныеОбъектаМетаданных(Метаданные.РегистрыСведений.ОбновленныеВерсииПриложения);
...
Функция ПараметрыОткрытияФормыУстановкиПодмены(ВерсияОбработки, ДляТекущегоПользователя) Экспорт
	...
	ПараметрыФормы.Вставить("ИмяФормы", Метаданные.РегистрыСведений.ПодменаПлатформенныхОбработок.Формы.ФормаЗаписи.ПолноеИмя());
